...
import { LandingPage, AuthPage, SubmissionForm, AdminDashboard, PublicDirectory, UserProfile, WikimediaCallbackPage } from './pages';
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
          <Routes>
            ...
            <Route path="/auth/wikimedia/success" element={<WikimediaCallbackPage />} />
