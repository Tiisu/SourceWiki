...
const NotificationSystem: React.FC<NotificationSystemProps> = ({
  ...
  useEffect(() => {
    const converted: NotificationItem[] = notifications.slice(0, maxNotifications).map((notification, index) => {
      ...
      switch (type) {
        case 'submission:created': // Explicitly cast type to match NotificationItem['type']
      ...
      return {
        ...
        type: type as NotificationItem['type'], // Cast type to match NotificationItem['type']
        title,
        message,
        timestamp,
        read: false,
